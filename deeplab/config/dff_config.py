...
config.dataset.dataset_video_path = './data/cityscapes_video/leftImg8bit_sequence'
config.dataset.video_gt_path = './data/cityscapes_video/gtFine_sequence_own' # video sequence gt folder
...
# Video mode:(for load data)
config.TRAIN.VIDEO = True
# for tensorboard file
config.TRAIN.TB_DIR = ''

config.TEST = edict()
# size of images for each device
config.TEST.BATCH_IMAGES = 1
config.TEST.OFFSET = -1
# Test Model Epoch
